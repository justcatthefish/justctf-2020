...
type config struct {
	...
	SandboxDuration     time.Duration `default:"7200s" split_words:"true"`
	SandboxNewCreation  time.Duration `default:"1800s" split_words:"true"`

	OneTimeHashDuration time.Duration `default:"60s" split_words:"true"`

	HashcashDifficult   int `default:"28" split_words:"true"`
	MaxCores 			int `default:"8" split_words:"true"`
